...
function renderHostOpenDesk(input: {
  ...
  const afterLock = locked
    ? " open-after-lock-first open-after-lock-two open-after-lock-three"
    : "";
  const afterLockMarks = locked
    ? " data-open-next data-open-after-lock data-open-after-lock-first data-open-after-lock-two data-open-after-lock-three"
    : "";
