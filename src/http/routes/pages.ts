...
function renderLockedClaim(episode: Episode): string {
  ...
  return `<section class="claim lock-after-open-first lock-after-open-two lock-after-open-three lock-after-open-four" id="claim" data-claim-locked data-lock-after-open data-lock-after-open-first data-lock-after-open-two data-lock-after-open-three data-lock-after-open-four>
...
function renderHostOpenDesk(input: {
  ...
  const afterLock = locked
    ? " open-after-lock-first open-after-lock-two open-after-lock-three open-after-lock-four"
    : "";
  const afterLockMarks = locked
    ? " data-open-next data-open-after-lock data-open-after-lock-first data-open-after-lock-two data-open-after-lock-three data-open-after-lock-four"
    : "";
